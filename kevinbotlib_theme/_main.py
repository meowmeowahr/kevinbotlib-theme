...
from kevinbotlib_theme._style_loader import load_palette, load_stylesheet
...
def _apply_style(app, additional_qss: str | None, **kargs) -> None:
    from kevinbotlib_theme._proxy_style import QDarkThemeStyle
...
def _sync_theme_with_system(app, callback) -> None:
    from kevinbotlib_theme._os_appearance import listener
...
def enable_hi_dpi() -> None:
    ...
    """
    from kevinbotlib_theme.qtpy.QtCore import Qt
    from kevinbotlib_theme.qtpy.QtGui import QGuiApplication
    ...
    *,
    ...
    Examples:
        ...
        2. Use Dark Theme ::
            ...
            app = QApplication([])
            kevinbotlib_theme.setup_theme("dark")

        3. Sharp corner ::

            # Change corner shape to sharp.
            app = QApplication([])
            kevinbotlib_theme.setup_theme(corner_shape="sharp")

        4. Customize color ::

            app = QApplication([])
            kevinbotlib_theme.setup_theme(custom_colors={"primary": "#D0BCFF"})
    ...
    if theme != "auto":
        stop_sync()
    app.setProperty("_kevinbotlib_theme_use_setup_style", True)
