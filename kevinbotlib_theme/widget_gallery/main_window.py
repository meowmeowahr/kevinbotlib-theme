...
from kevinbotlib_theme._util import get_kevinbotlib_theme_root_path
from kevinbotlib_theme.qtpy.QtCore import QDir, Qt, Slot
from kevinbotlib_theme.qtpy.QtGui import QAction, QActionGroup, QFont, QIcon
from kevinbotlib_theme.qtpy.QtWidgets import (
    QColorDialog,
    QFileDialog,
    QFontDialog,
    QLabel,
...
from kevinbotlib_theme.widget_gallery._ui.dock_ui import DockUI
from kevinbotlib_theme.widget_gallery._ui.frame_ui import FrameUI
from kevinbotlib_theme.widget_gallery._ui.icons_ui import IconsUi
from kevinbotlib_theme.widget_gallery._ui.mdi_ui import MdiUI
from kevinbotlib_theme.widget_gallery._ui.widgets_ui import WidgetsUI
...
class WidgetGallery(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        super().__init__()
        QDir.addSearchPath("icons", f"{get_kevinbotlib_theme_root_path().as_posix()}/widget_gallery/svg")
    ...
    def _change_theme(self) -> None:
        ...
        kevinbotlib_theme.setup_theme(self._theme, self._corner_shape)
